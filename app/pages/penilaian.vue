<template>
  <div class="space-y-6">
    <div>
      <h1 class="text-xl lg:text-2xl font-bold text-gray-900">Penilaian</h1>
    ...
    <div v-else-if="!loading" class="space-y-4">
      <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div
          class="px-4 lg:px-6 py-4 border-b border-gray-100 flex items-center justify-between"
        >
        ...
        <div class="sm:hidden divide-y divide-gray-100">
          <div v-for="p in providerList" :key="p.id" class="p-4 space-y-3">
            <div class="flex items-center gap-3">
              <div
                class="w-8 h-8 rounded-xl bg-gray-100 flex items-center justify-center text-sm font-bold text-gray-600"
              >
            ...
            <div class="space-y-2">
              ...
              >
                <div class="w-28 shrink-0">
                  <p class="text-xs font-medium text-gray-700">{{ k.nama }}</p>
                  <span
                    class="text-xs"
                    :class="
                      k.jenis === 'benefit' ? 'text-green-500' : 'text-red-500'
                    "
                  >
                ...
                <input
                  ...
                  min="0"
                  placeholder="0"
                  class="flex-1 border border-gray-200 rounded-xl px-3 py-2 text-sm outline-none focus:border-gray-900 transition-all text-center"
                />
              </div>
            </div>
          </div>
